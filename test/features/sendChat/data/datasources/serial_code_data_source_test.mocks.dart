...
// in chat_bot_frontend/test/features/sendChat/data/datasources/serial_code_data_source_test.dart.
...
class MockSerialCodeDataSource extends _i1.Mock
    implements _i3.SerialCodeDataSource {
  ...
  @override
  _i5.Future<bool> validateCode(String? serialCode) => (super.noSuchMethod(
        Invocation.method(
          #validateCode,
          [serialCode],
        ),
